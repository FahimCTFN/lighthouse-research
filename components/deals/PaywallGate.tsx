    ...
    return (
      <section className="rounded-lg border border-brand-gold/40 bg-brand-gold-light/30 px-7 py-8 text-center">
        ...
        <p className="mx-auto mt-2 max-w-[420px] text-[13px] leading-[1.6] text-gray-600">
          ...
          since then. Subscribe for the latest intelligence on this and
          every active situation.
        </p>
        <div className="mt-5">
          <Link
            href="/subscribe"
            className="inline-block rounded bg-brand-navy px-8 py-2.5 text-[13px] font-medium text-white hover:bg-brand-navy-dark"
          >
            Subscribe — $499/mo
          </Link>
        </div>
