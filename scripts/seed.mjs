  ...
  // 1 ── WBD / PSKY — the mockup deal
  {
    ...
    filings: [
      ...
      },
      {
        ...
        outcome: "pending",
        outcome_summary: "FSR clearance required in addition to EC merger control. Pre-notification discussions ongoing.",
        steps: [
          { _key: k(), label: "Pre-notification discussions", actual_date: "2026-03-10" },
          { _key: k(), label: "FSR notification filed", expected_date: "2026-05-15" },
          { _key: k(), label: "FSR decision", expected_date: "2026-06-30" },
        ],
      },
      {
        _key: k(),
        jurisdiction: "CADE",
        outcome: "pending",
        outcome_summary: "Brazilian antitrust notification filed March 31, 2026.",
        steps: [
          { _key: k(), label: "CADE notification filed", actual_date: "2026-03-31" },
          { _key: k(), label: "CADE decision", expected_date: "2026-06-30" },
        ],
      },
      {
        _key: k(),
