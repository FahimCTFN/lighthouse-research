...
const deals = [
  // 1 ── WBD / PSKY — the mockup deal
  {
    ...
    documents: [
      { _key: k(), title: "Press Release — WBD/PSKY (2/27/26)", url: "https://www.sec.gov/" },
      { _key: k(), title: "Definitive Merger Agreement (WBD/PSKY)", url: "https://www.sec.gov/" },
      { _key: k(), title: "Definitive Proxy Statement (WBD/PSKY)", url: "https://www.sec.gov/" },
      { _key: k(), title: "WBD Spinoff Press Release (6/9/25)", url: "https://www.sec.gov/" },
      { _key: k(), title: "WBD Strategic Review Press Release (10/21/25)", url: "https://www.sec.gov/" },
      { _key: k(), title: "Enhanced Paramount Bid (2/10/26)", url: "https://www.sec.gov/" },
      { _key: k(), title: "Teamsters asks DOJ to Block Merger (3/12/26)", url: "https://www.sec.gov/" },
  ...
  // 10 ── SLAB / TXN — semiconductor acquisition
  {
    ...
    filings: [
      ...
      },
      {
        _key: k(),
        jurisdiction: "Other",
        display_name: "Other antitrust + FDI",
        outcome: "pending",
        outcome_summary: "Approval under foreign antitrust and FDI laws is required.",
        steps: [
          { _key: k(), label: "Foreign antitrust + FDI filings", expected_date: "2026-05-30" },
          { _key: k(), label: "Clearances", expected_date: "2026-12-31" },
        ],
      },
    ],
    shareholder_vote: {
      ...
      steps: [
        { _key: k(), label: "Proxy statement filing deadline", actual_date: "2026-03-12" },
        { _key: k(), label: "HSR filing deadline", actual_date: "2026-03-19" },
        { _key: k(), label: "HSR expiration", expected_date: "2026-04-20" },
    ...
    documents: [
      ...
      { _key: k(), title: "Definitive Proxy Statement", url: "https://www.sec.gov/Archives/edgar/data/1038074/000119312526128959/d34834ddefm14a.htm" },
    ],
    trigger_alert: false,
